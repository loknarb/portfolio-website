...
const GridPoints = () => {
  ...
  return (
    <div className='grid tablet:grid-cols-3 tablet:p-8 tablet:gap-14 gap-14 max-w-7xl  mx-auto tablet:bg-zinc-800 dark dark:text-zinc-200 dark:text-zinc-300 rounded my-4 w-full pt-72'>
      <PrimaryCard>
